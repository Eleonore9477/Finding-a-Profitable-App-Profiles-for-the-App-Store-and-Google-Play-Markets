...
for row in apps_data[1:]:
    ...
    price = float(row[4])
    if price > 9:
        price_above_nine.append(rating)
avg_rating = sum(price_above_nine) / len(price_above_nine)
print(avg_rating)
#How many apps have a price greater than 9
n_apps_more_9 = len(price_above_nine)   

#how many apps have a price less than or equal to 9
n_apps_less_9 = len(apps_data[1:]) -len(price_above_nine)
